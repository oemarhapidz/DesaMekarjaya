            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  key={link.href}
                  href={link.href}
                  className={`rounded-[5rem] px-3.5 py-2 text-sm font-semibold transition ${isActive
            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  ...
                  className={`rounded-[5rem] px-4 py-2 text-sm font-semibold transition ${isActive
